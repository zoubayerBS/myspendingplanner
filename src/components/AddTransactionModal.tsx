        ...
        <form onSubmit={handleSubmit} className="p-4 space-y-4 overflow-hidden">
          ...
          <div>
            ...
            <input
              ...
              required
              className="w-full max-w-[200px] min-w-0 text-sm bg-slate-50 border border-slate-200 rounded-lg py-2 px-3 focus:outline-none focus:border-[#1B3022] transition-colors box-border"
            />
          </div>
